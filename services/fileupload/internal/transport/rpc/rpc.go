...
func New(ctx context.Context, app *app.App) *RPC {
	...
	svr.Register("create_upload", "2025-02-12", schema("create_upload"), rpc.HandleCreateUpload)
	svr.Register("confirm_upload", "2025-02-12", schema("confirm_upload"), rpc.HandleConfirmUpload)
	svr.Register("get_file", "2025-02-12", schema("get_file"), rpc.HandleGetFile)
